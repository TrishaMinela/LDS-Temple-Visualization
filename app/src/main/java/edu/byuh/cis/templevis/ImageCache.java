...
public class ImageCache {
    ...
    public static void init(Resources res, float w2, float h) {
        ...
        idaho_falls_temple = loadAndScale(res, R.drawable.idaho_falls_idaho_temple, w);
        bern_switzerland_temple = loadAndScale(res, R.drawable.bern_switzerland_temple, w);
        los_angeles_temple = loadAndScale(res, R.drawable.los_angeles_california_temple, w);
        ...
        oakland_temple = loadAndScale(res, R.drawable.oakland_california_temple, w);
        ogden_utah_temple = loadAndScale(res, R.drawable.ogden_utah_temple, w);
        provo_temple = loadAndScale(res, R.drawable.provo_utah_temple, w);
        ...
        seattle_temple = loadAndScale(res, R.drawable.seattle_washington_temple, w);
        jordan_river_temple = loadAndScale(res, R.drawable.jordan_river_utah_temple, w);
        atlanta_temple = loadAndScale(res, R.drawable.atlanta_georgia_temple, w);
        ...
        mexico_city_temple = loadAndScale(res, R.drawable.mexico_city_mexico_temple, w);
        ...
        guatemala_lds_temple = loadAndScale(res, R.drawable.guatemala_city_guatemala_temple, w);
        freiberg_germany_temple = loadAndScale(res, R.drawable.freiberg_germany_temple, w);
        stockholm_sweden_lds_temple = loadAndScale(res, R.drawable.stockholm_sweden_temple, w);
        chicago_temple = loadAndScale(res, R.drawable.chicago_illinois_temple, w);
        ...
        denver_colorado_templ = loadAndScale(res, R.drawable.denver_colorado_temple, w);
        ...
        las_vegas_temple = loadAndScale(res, R.drawable.las_vegas_nevada_temple, w);
        toronto_temple = loadAndScale(res, R.drawable.toronto_ontario_temple, w);
        san_diego_california_temple = loadAndScale(res, R.drawable.san_diego_california_temple, w);
        orlando_temple = loadAndScale(res, R.drawable.orlando_florida_temple, w);
        bountiful_temple = loadAndScale(res, R.drawable.bountiful_utah_temple, w);
        ...
        st_louis_temple = loadAndScale(res, R.drawable.st_louis_missouri_temple, w);
        ...
        bismark_north_dakota_temple = loadAndScale(res, R.drawable.bismarck_north_dakota_temple, w);
        columbia_temple = loadAndScale(res, R.drawable.columbia_south_carolina_temple, w);
        detroit_temple = loadAndScale(res, R.drawable.detroit_michigan_temple, w);
        halifax_nova_scotia_lds_temple = loadAndScale(res, R.drawable.halifax_nova_scotia_temple, w);
        regina_temple = loadAndScale(res, R.drawable.regina_saskatchewan_temple, w);
        ...
        st_paul_temple = loadAndScale(res, R.drawable.st_paul_minnesota_temple, w);
        kona_temple = loadAndScale(res, R.drawable.kona_hawaii_temple, w);
        ...
        medford_temple = loadAndScale(res, R.drawable.medford_oregon_temple, w);
        memphis_tennessee_temple = loadAndScale(res, R.drawable.memphis_tennessee_temple, w);
        reno_nevada_lds_temple = loadAndScale(res, R.drawable.reno_nevada_temple, w);
        ...
        nashville_temple = loadAndScale(res, R.drawable.nashville_tennessee_temple, w);
        ...
        boston_temple = loadAndScale(res, R.drawable.boston_massachusetts_temple, w);
        ...
        winter_quarters_temple = loadAndScale(res, R.drawable.winter_quarters_nebraska_temple, w);
        guadalajara_temple = loadAndScale(res, R.drawable.guadalajara_mexico_temple, w);
        perth_australia_temple = loadAndScale(res, R.drawable.perth_australia_temple, w);
        columbia_river_temple = loadAndScale(res, R.drawable.columbia_river_washington_temple, w);
        snowflake_temple = loadAndScale(res, R.drawable.snowflake_arizona_temple, w);
        lubbock_temple = loadAndScale(res, R.drawable.lubbock_texas_temple, w);
        ...
        redlands_temple = loadAndScale(res, R.drawable.redlands_california_temple, w);
        ...
        manhattan_temple = loadAndScale(res, R.drawable.manhattan_new_york_temple, w);
        san_antonio_temple = loadAndScale(res, R.drawable.san_antonio_texas_temple, w);
        ...
        sacramento_temple = loadAndScale(res, R.drawable.sacramento_california_temple, w);
        ...
        panama_city_temple = loadAndScale(res, R.drawable.panama_city_panama_temple, w);
        twin_falls_temple = loadAndScale(res, R.drawable.twin_falls_idaho_temple, w);
        ...
        vancouver_temple = loadAndScale(res, R.drawable.vancouver_british_columbia_temple, w);
        gila_valley_temple = loadAndScale(res, R.drawable.the_gila_valley_arizona_temple, w);
        cebu_philippines_temple = loadAndScale(res, R.drawable.cebu_city_philippines_temple, w);
        ...
        barranquilla_columbia_temple = loadAndScale(res, R.drawable.barranquilla_colombia_temple, w);
        ...
        praia_cape_verde_temple = loadAndScale(res, R.drawable.praia_cabo_verde_temple, w);
        ...
        okinawa_city_okinawa_temple = loadAndScale(res, R.drawable.okinawa_japan_temple, w);
        ...
        russia_temple = loadAndScale(res, R.drawable.russia_administration_building, w);
        ...
        sao_paulo_east_brazil_temple = loadAndScale(res, R.drawable.sao_paulo_brazil_east_temple, w);
    ...
    public static ArrayList<Integer> getAllImageIds() {
        ...
        allImageIds.add(R.drawable.idaho_falls_idaho_temple_large);
        allImageIds.add(R.drawable.bern_switzerland_temple_large);
        allImageIds.add(R.drawable.los_angeles_california_temple_large);
        allImageIds.add(R.drawable.hamilton_new_zealand_temple_large);
        allImageIds.add(R.drawable.london_england_temple_large);
        allImageIds.add(R.drawable.oakland_california_temple_large);
        allImageIds.add(R.drawable.ogden_utah_temple_large);
        allImageIds.add(R.drawable.provo_utah_temple_large);
        ...
        allImageIds.add(R.drawable.seattle_washington_temple_large);
        allImageIds.add(R.drawable.jordan_river_utah_temple_large);
        allImageIds.add(R.drawable.atlanta_georgia_temple_large);
        ...
        allImageIds.add(R.drawable.mexico_city_mexico_temple_large);
        ...
        allImageIds.add(R.drawable.guatemala_city_guatemala_temple_large);
        allImageIds.add(R.drawable.freiberg_germany_temple_large);
        allImageIds.add(R.drawable.stockholm_sweden_temple_large);
        allImageIds.add(R.drawable.chicago_illinois_temple_large);
        ...
        allImageIds.add(R.drawable.denver_colorado_temple_large);
        allImageIds.add(R.drawable.frankfurt_germany_temple_large);
        allImageIds.add(R.drawable.portland_oregon_temple_large);
        allImageIds.add(R.drawable.las_vegas_nevada_temple_large);
        allImageIds.add(R.drawable.toronto_ontario_temple_large);
        allImageIds.add(R.drawable.san_diego_california_temple_large);
        allImageIds.add(R.drawable.orlando_florida_temple_large);
        allImageIds.add(R.drawable.bountiful_utah_temple_large);
        allImageIds.add(R.drawable.hong_kong_china_temple_large);
        allImageIds.add(R.drawable.mount_timpanogos_utah_temple_large);
        allImageIds.add(R.drawable.st_louis_missouri_temple_large);
        ...
        allImageIds.add(R.drawable.bismarck_north_dakota_temple_large);
        allImageIds.add(R.drawable.columbia_south_carolina_temple_large);
        allImageIds.add(R.drawable.detroit_michigan_temple_large);
        allImageIds.add(R.drawable.halifax_nova_scotia_temple_large);
        allImageIds.add(R.drawable.regina_saskatchewan_temple_large);
        ...
        allImageIds.add(R.drawable.st_paul_minnesota_temple_large);
        allImageIds.add(R.drawable.kona_hawaii_temple_large);
        ...
        allImageIds.add(R.drawable.boston_massachusetts_temple_large);
        ...
        allImageIds.add(R.drawable.winter_quarters_nebraska_temple_large);
        allImageIds.add(R.drawable.guadalajara_mexico_temple_large);
        allImageIds.add(R.drawable.perth_australia_temple_large);
        allImageIds.add(R.drawable.columbia_river_washington_temple_large);
        allImageIds.add(R.drawable.snowflake_arizona_temple_large);
        allImageIds.add(R.drawable.lubbock_texas_temple_large);
        ...
        allImageIds.add(R.drawable.redlands_california_temple_large);
        allImageIds.add(R.drawable.accra_ghana_temple_large);
        allImageIds.add(R.drawable.copenhagen_denmark_temple_large);
        allImageIds.add(R.drawable.manhattan_new_york_temple_large);
        allImageIds.add(R.drawable.san_antonio_texas_temple_large);
        allImageIds.add(R.drawable.aba_nigeria_temple_large);
        allImageIds.add(R.drawable.newport_beach_california_temple_large);
        allImageIds.add(R.drawable.sacramento_california_temple_large);
        ...
        allImageIds.add(R.drawable.panama_city_panama_temple_large);
        allImageIds.add(R.drawable.twin_falls_idaho_temple_large);
        allImageIds.add(R.drawable.draper_utah_temple_large);
        allImageIds.add(R.drawable.oquirrh_mountain_utah_temple_large);
        allImageIds.add(R.drawable.vancouver_british_columbia_temple_large);
        allImageIds.add(R.drawable.the_gila_valley_arizona_temple_large);
        allImageIds.add(R.drawable.cebu_city_philippines_temple_large);
        ...
        allImageIds.add(R.drawable.barranquilla_colombia_temple_large);
        ...
        allImageIds.add(R.drawable.praia_cabo_verde_temple_large);
        ...
        allImageIds.add(R.drawable.russia_administration_building_large);
        ...
        allImageIds.add(R.drawable.okinawa_japan_temple_large);
        ...
        allImageIds.add(R.drawable.greater_guatemala_city_guatemala_temple);
        allImageIds.add(R.drawable.sao_paulo_brazil_east_temple_large);
