 ...
 */
    ...
    */
    ...
    public static ArrayList<Integer> getAllSpiralImageIds() {
        ...
        allImageIds.add(R.drawable.kirtland_temple);
        allImageIds.add(R.drawable.old_nauvoo_temple);
        allImageIds.add(R.drawable.st_george_temple);
        allImageIds.add(R.drawable.logan_temple);
        allImageIds.add(R.drawable.manti_temple);
        allImageIds.add(R.drawable.salt_lake_temple);
        allImageIds.add(R.drawable.laie_hawaii_temple);
        allImageIds.add(R.drawable.cardston_alberta_temple);
        allImageIds.add(R.drawable.mesa_temple);
        allImageIds.add(R.drawable.idaho_falls_temple);
        allImageIds.add(R.drawable.bern_switzerland_temple);
        allImageIds.add(R.drawable.los_angeles_temple);
        allImageIds.add(R.drawable.hamilton_new_zealand_temple);
        allImageIds.add(R.drawable.london_england_temple);
        allImageIds.add(R.drawable.oakland_temple);
        allImageIds.add(R.drawable.ogden_utah_temple);
        allImageIds.add(R.drawable.provo_temple);
        allImageIds.add(R.drawable.washington_dc_temple);
        allImageIds.add(R.drawable.sao_paulo_brazil_temple);
        allImageIds.add(R.drawable.tokyo_japan_temple);
        allImageIds.add(R.drawable.seattle_temple);
        allImageIds.add(R.drawable.jordan_river_temple);
        allImageIds.add(R.drawable.atlanta_temple);
        allImageIds.add(R.drawable.apia_samoa_temple);
        allImageIds.add(R.drawable.nukualofa_tonga_temple);
        allImageIds.add(R.drawable.santiago_chile_temple);
        allImageIds.add(R.drawable.papeete_tahiti_temple);
        allImageIds.add(R.drawable.mexico_city_temple);
        allImageIds.add(R.drawable.boise_idaho_temple);
        allImageIds.add(R.drawable.sydney_australia_temple);
        allImageIds.add(R.drawable.manila_philippines_temple);
        allImageIds.add(R.drawable.dallas_texas_temple);
        allImageIds.add(R.drawable.taipei_taiwan_temple);
        allImageIds.add(R.drawable.guatemala_lds_temple);
        allImageIds.add(R.drawable.freiberg_germany_temple);
        allImageIds.add(R.drawable.stockholm_sweden_lds_temple);
        allImageIds.add(R.drawable.chicago_temple);
        allImageIds.add(R.drawable.johannesburg_south_africa_temple);
        allImageIds.add(R.drawable.seoul_korea_temple);
        allImageIds.add(R.drawable.lima_peru_temple);
        allImageIds.add(R.drawable.buenos_aires_argentina_temple);
        allImageIds.add(R.drawable.denver_colorado_templ);
        allImageIds.add(R.drawable.frankfurt_germany_temple);
        allImageIds.add(R.drawable.portland_oregon_temple);
        allImageIds.add(R.drawable.las_vegas_temple);
        allImageIds.add(R.drawable.toronto_temple);
        allImageIds.add(R.drawable.san_diego_california_temple);
        allImageIds.add(R.drawable.orlando_temple);
        allImageIds.add(R.drawable.bountiful_temple);
        allImageIds.add(R.drawable.hong_kong_china_temple);
        allImageIds.add(R.drawable.mount_timpanogos_utah_temple);
        allImageIds.add(R.drawable.st_louis_temple);
        allImageIds.add(R.drawable.vernal_temple);
        allImageIds.add(R.drawable.preston_england_temple);
        allImageIds.add(R.drawable.monticello_utah_temple);
        allImageIds.add(R.drawable.anchorage_alaska_temple);
        allImageIds.add(R.drawable.colonia_juarez_mexico_temple);
        allImageIds.add(R.drawable.madrid_spain_temple);
        allImageIds.add(R.drawable.bogota_colombia_temple);
        allImageIds.add(R.drawable.guayaquil_ecuador_temple);
        allImageIds.add(R.drawable.spokane_washington_temple);
        allImageIds.add(R.drawable.columbus_ohio_temple);
        allImageIds.add(R.drawable.bismark_north_dakota_temple);
        allImageIds.add(R.drawable.columbia_temple);
        allImageIds.add(R.drawable.detroit_temple);
        allImageIds.add(R.drawable.halifax_nova_scotia_lds_temple);
        allImageIds.add(R.drawable.regina_temple);
        allImageIds.add(R.drawable.billings_montana_temple);
        allImageIds.add(R.drawable.edmonton_alberta_temple);
        allImageIds.add(R.drawable.raleigh_north_carolina_temple);
        allImageIds.add(R.drawable.st_paul_temple);
        allImageIds.add(R.drawable.kona_temple);
        allImageIds.add(R.drawable.ciudad_juarez_mexico_temple);
        allImageIds.add(R.drawable.hermosillo_sonora_mexico_temple);
        allImageIds.add(R.drawable.albuquerque_temple);
        allImageIds.add(R.drawable.oaxaca_mexico_temple);
        allImageIds.add(R.drawable.tuxtla_guitierrez_mexico_temple);
        allImageIds.add(R.drawable.louisville_temple);
        allImageIds.add(R.drawable.palmyra_temple);
        allImageIds.add(R.drawable.fresno_temple);
        allImageIds.add(R.drawable.medford_temple);
        allImageIds.add(R.drawable.memphis_tennessee_temple);
        allImageIds.add(R.drawable.reno_nevada_lds_temple);
        allImageIds.add(R.drawable.cochabamba_bolivia_temple);
        allImageIds.add(R.drawable.tampico_mexico_temple);
        allImageIds.add(R.drawable.nashville_temple);
        allImageIds.add(R.drawable.villahermosa_mexico_temple);
        allImageIds.add(R.drawable.montreal_quebec_temple);
        allImageIds.add(R.drawable.san_jose_costa_rica_temple);
        allImageIds.add(R.drawable.fukuoka_japan_temple);
        allImageIds.add(R.drawable.adelaide_australia_temple);
        allImageIds.add(R.drawable.melbourne_australia_temple);
        allImageIds.add(R.drawable.suva_fiji_temple);
        allImageIds.add(R.drawable.merida_mexico_temple);
        allImageIds.add(R.drawable.veracruz_mexico_temple);
        allImageIds.add(R.drawable.baton_rouge_louisiana_temple);
        allImageIds.add(R.drawable.oklahoma_city_temple);
        allImageIds.add(R.drawable.caracas_venezuela_temple);
        allImageIds.add(R.drawable.houston_texas_temple);
        allImageIds.add(R.drawable.birmingham_alabama_temple);
        allImageIds.add(R.drawable.santo_domingo_dominican_republic_temple);
        allImageIds.add(R.drawable.boston_temple);
        allImageIds.add(R.drawable.recife_brazil_temple);
        allImageIds.add(R.drawable.porto_alegre_brazil_temple);
        allImageIds.add(R.drawable.montevideo_uruguay_temple);
        allImageIds.add(R.drawable.winter_quarters_temple);
        allImageIds.add(R.drawable.guadalajara_temple);
        allImageIds.add(R.drawable.perth_australia_temple);
        allImageIds.add(R.drawable.columbia_river_temple);
        allImageIds.add(R.drawable.snowflake_temple);
        allImageIds.add(R.drawable.lubbock_temple);
        allImageIds.add(R.drawable.monterrey_mexico_temple);
        allImageIds.add(R.drawable.campinas_brazil_temple);
        allImageIds.add(R.drawable.asuncion_paraguay_temple);
        allImageIds.add(R.drawable.nauvoo_temple);
        allImageIds.add(R.drawable.the_hague_netherlands_temple);
        allImageIds.add(R.drawable.brisbane_australia_temple);
        allImageIds.add(R.drawable.redlands_temple);
        allImageIds.add(R.drawable.accra_ghana_temple);
        allImageIds.add(R.drawable.copenhagen_denmark_temple);
        allImageIds.add(R.drawable.manhattan_temple);
        allImageIds.add(R.drawable.san_antonio_temple);
        allImageIds.add(R.drawable.aba_nigeria_temple);
        allImageIds.add(R.drawable.newport_beach_california_temple);
        allImageIds.add(R.drawable.sacramento_temple);
        allImageIds.add(R.drawable.helsinki_finland_temple);
        allImageIds.add(R.drawable.rexburg_idaho_temple);
        allImageIds.add(R.drawable.curitiba_brazil_temple);
        allImageIds.add(R.drawable.panama_city_temple);
        allImageIds.add(R.drawable.twin_falls_temple);
        allImageIds.add(R.drawable.draper_utah_temple);
        allImageIds.add(R.drawable.oquirrh_mountain_utah_temple);
        allImageIds.add(R.drawable.vancouver_temple);
        allImageIds.add(R.drawable.gila_valley_temple);
        allImageIds.add(R.drawable.cebu_philippines_temple);
        allImageIds.add(R.drawable.kyiv_ukraine_temple);
        allImageIds.add(R.drawable.san_salvador_el_salvador_temple);
        allImageIds.add(R.drawable.quetzaltenango_guatemala_temple);
        allImageIds.add(R.drawable.kansas_city_temple);
        allImageIds.add(R.drawable.manaus_brazil_temple);
        allImageIds.add(R.drawable.brigham_city_utah_temple);
        allImageIds.add(R.drawable.calgary_alberta_lds_temple);
        allImageIds.add(R.drawable.tegucigalpa_honduras_temple);
        allImageIds.add(R.drawable.gilbert_arizona_temple);
        allImageIds.add(R.drawable.fort_lauderdale_florida_temple);
        allImageIds.add(R.drawable.phoenix_arizona_temple);
        allImageIds.add(R.drawable.cordoba_argentina_temple);
        allImageIds.add(R.drawable.payson_utah_temple);
        allImageIds.add(R.drawable.trujillo_peru_temple);
        allImageIds.add(R.drawable.indianapolis_indiana_temple);
        allImageIds.add(R.drawable.tijuana_mexico_temple);
        allImageIds.add(R.drawable.provo_city_center_temple);
        allImageIds.add(R.drawable.sapporo_japan_temple);
        allImageIds.add(R.drawable.philadelphia_pennsylvania_temple);
        allImageIds.add(R.drawable.fort_collins_colorado_temple);
        allImageIds.add(R.drawable.star_valley_wyoming_temple);
        allImageIds.add(R.drawable.hartford_connecticut_temple);
        allImageIds.add(R.drawable.paris_france_temple);
        allImageIds.add(R.drawable.tucson_arizona_temple);
        allImageIds.add(R.drawable.meridian_idaho_temple);
        allImageIds.add(R.drawable.cedar_city_utah_temple);
        allImageIds.add(R.drawable.concepcion_chile_temple);
        allImageIds.add(R.drawable.barranquilla_columbia_temple);
        allImageIds.add(R.drawable.rome_italy_temple);
        allImageIds.add(R.drawable.kinshasa_temple);
        allImageIds.add(R.drawable.fortaleza_brazil_temple);
        allImageIds.add(R.drawable.haiti_temple_exterior);
        allImageIds.add(R.drawable.lisbon_portugal_temple);
        allImageIds.add(R.drawable.arequipa_peru_temple);
        allImageIds.add(R.drawable.durban_south_africa_temple);
        allImageIds.add(R.drawable.abidjan_ivory_coast_temple);
        allImageIds.add(R.drawable.bangkok_thailand_temple);
        allImageIds.add(R.drawable.belem_brazil_temple);
        allImageIds.add(R.drawable.lima_peru_los_olivos_temple);
        allImageIds.add(R.drawable.pocatello_idaho_temple);
        allImageIds.add(R.drawable.praia_cape_verde_temple);
        allImageIds.add(R.drawable.puebla_mexico_temple);
        allImageIds.add(R.drawable.quito_ecuador_temple);
        allImageIds.add(R.drawable.richmond_virginia_temple);
        allImageIds.add(R.drawable.rio_de_janeiro_brazil_temple);
        allImageIds.add(R.drawable.san_juan_puerto_rico_temple);
        allImageIds.add(R.drawable.saratoga_springs_utah_temple);
        allImageIds.add(R.drawable.urdaneta_philippines_temple);
        allImageIds.add(R.drawable.winnipeg_manitoba_temple);
        allImageIds.add(R.drawable.yigo_guam_temple);
        allImageIds.add(R.drawable.alabang_philippines_temple);
        allImageIds.add(R.drawable.antofagasta_chile_temple);
        allImageIds.add(R.drawable.auckland_new_zealand_temple);
        allImageIds.add(R.drawable.bacolod_philippines_temple);
        allImageIds.add(R.drawable.bahia_blanca_argentina_temple);
        allImageIds.add(R.drawable.bengaluru_india_temple);
        allImageIds.add(R.drawable.benin_city_nigeria_temple);
        allImageIds.add(R.drawable.bentonville_arkansas_temple);
        allImageIds.add(R.drawable.brasilia_brazil_temple);
        allImageIds.add(R.drawable.budapest_hungary_temple);
        allImageIds.add(R.drawable.cagayan_de_oro_philippines_temple);
        allImageIds.add(R.drawable.coban_guatemala_temple);
        allImageIds.add(R.drawable.davao_philippines_temple);
        allImageIds.add(R.drawable.dubai_united_arab_emirates_temple);
        allImageIds.add(R.drawable.feather_river_california_temple);
        allImageIds.add(R.drawable.freetown_sierra_leone_temple);
        allImageIds.add(R.drawable.harare_zimbabwe_temple);
        allImageIds.add(R.drawable.lagos_nigeria_temple);
        allImageIds.add(R.drawable.layton_utah_temple);
        allImageIds.add(R.drawable.lubumbashi_democratic_republic_of_the_congo_temple);
        allImageIds.add(R.drawable.managua_nicaragua_temple);
        allImageIds.add(R.drawable.mcallen_texas_temple);
        allImageIds.add(R.drawable.mendoza_argentina_temple);
        allImageIds.add(R.drawable.moses_lake_washington_temple);
        allImageIds.add(R.drawable.nairobi_kenya_temple);
        allImageIds.add(R.drawable.neiafu_tonga_temple);
        allImageIds.add(R.drawable.okinawa_city_okinawa_temple);
        allImageIds.add(R.drawable.orem_utah_temple);
        allImageIds.add(R.drawable.pago_pago_american_samoa_temple);
        allImageIds.add(R.drawable.phnom_penh_cambodia_temple);
        allImageIds.add(R.drawable.pittsburgh_pennsylvania_temple);
        allImageIds.add(R.drawable.port_moresby_papua_new_guinea_temple);
        allImageIds.add(R.drawable.russia_temple);
        allImageIds.add(R.drawable.salta_argentina_temple);
        allImageIds.add(R.drawable.salvador_brazil_temple);
        allImageIds.add(R.drawable.san_pedro_sula_honduras_temple);
        allImageIds.add(R.drawable.syracuse_utah_temple);
        allImageIds.add(R.drawable.tallahassee_florida_temple);
        allImageIds.add(R.drawable.taylorsville_utah_temple);
        allImageIds.add(R.drawable.tooele_valley_utah_temple);
        allImageIds.add(R.drawable.washington_county_utah_temple);
